...
-- 4‑question personalization quiz on its own page (`path1.html`)
...
2. Click a role to go to `signup.html`. After filling the form, you'll be redirected to `path1.html`.

## Files

- `index.html` — landing page with role cards.
- `signup.html` — stand‑alone sign‑up page.
-- `path1.html` — dedicated questionnaire page.
